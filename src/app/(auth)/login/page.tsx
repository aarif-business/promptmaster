    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <p className="font-sans text-xs tracking-[0.4em] uppercase text-steel/60 mb-2">Welcome Back</p>
          <h1 className="font-serif text-4xl text-steel">Sign In</h1>
        ...
        <form onSubmit={handleLogin} className="card-classic space-y-5">
          <div>
        ...
        <p className="text-center mt-6 font-sans text-sm text-slate/60">
          New scholar?{' '}
          <Link href="/signup" className="text-steel hover:text-steel-dark underline underline-offset-2">
            Begin your training
          </Link>
        </p>
      </div>
